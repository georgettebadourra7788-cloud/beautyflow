  ...
  return (
    <>
      <header className="px-container-padding pt-stack-lg pb-stack-md bg-surface sticky top-0 z-30">
        <h1 className="font-headline-lg text-headline-lg text-on-surface">Conversations</h1>
      </header>
      ...
      <main className="px-container-padding flex flex-col gap-stack-md pb-40">
        {loading ? (
          ...
          <div className="bg-surface-container-lowest rounded-2xl p-8 soft-shadow border border-surface-variant text-center">
            ...
            <p className="font-body-lg text-body-lg text-on-surface font-semibold mb-1">No conversations yet</p>
            <p className="font-body-md text-body-md text-on-surface-variant">
              Once a lead comes in, their message thread will show up here.
            </p>
          </div>
        ) : (
          leads.map((lead) => (
            <button
              ...
              className="text-left bg-surface-container-lowest rounded-2xl p-4 soft-shadow border border-surface-variant/50 flex items-center gap-4 hover:bg-surface-container transition-colors"
            >
